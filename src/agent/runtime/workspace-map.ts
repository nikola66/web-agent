...
export function buildWorkspaceMapBlock(): string {
  ...
  return [
    ...
    "|------|-------------------|-------|",
    "| read_file, write_file, edit_file, browse_workspace | `path` | Aliases: `file`, `filename`, `file_path` |",
    ...
    "",
    "First orientation step when unsure: `browse_workspace({\"action\":\"tree\",\"path\":\".\"})` or `browse_workspace({\"action\":\"list\",\"path\":\".webagent\"})`.",
    "",
