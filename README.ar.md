...
- **Loop Guard** (default on): browser-side MobileBERT MNLI classifier decides continue / stop / ask_user after each agent step; disable with `VITE_WEBAGENT_LOOP_GUARD=0` (راجع [docs/ar/agent-notes.md](docs/ar/agent-notes.md))
