...
**اللغات:** [English](../test-prompts.md) · [简体中文](../zh-CN/test-prompts.md) · [Español](../es/test-prompts.md) · [العربية](test-prompts.md)

# Prompts de prueba — Web Agent

Prompts seleccionados para humo y regresión. الصق مطالبات الإنجليزية كما هي في الدردشة. عدّل المسارات عند الحاجة.
