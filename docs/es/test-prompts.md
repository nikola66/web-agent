...
**Idiomas:** [English](../test-prompts.md) · [简体中文](../zh-CN/test-prompts.md) · [Español](test-prompts.md) · [العربية](../ar/test-prompts.md)

# Prompts de prueba — Web Agent

Prompts seleccionados para humo y regresión. Pega los prompts en inglés tal cual en el chat. Ajusta rutas si hace falta.
